// ═══════════════════════════════════════════════════════════════════════════════════
// 📄 validators/fileValidator.ts — ตรวจไฟล์รูปก่อนอัปโหลด (สลิป/รูปเข้างาน) ฝั่ง frontend
// ทำอะไร: เช็คชนิดไฟล์ (เฉพาะรูป) + ขนาด + ขนาดภาพก่อนส่งขึ้น server — กันอัปไฟล์ผิด/ใหญ่เกินตั้งแต่ต้น
//   คืน { valid, error, dimensions } ให้หน้าที่เรียก (เช่น PreOrder อัปสลิป) ตัดสินใจต่อ
// ═══════════════════════════════════════════════════════════════════════════════════
/**
