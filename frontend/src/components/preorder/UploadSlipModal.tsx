// 📄 components/preorder/UploadSlipModal.tsx — popup ส่งสลิปโอนเงินใหม่ (ใช้ซ้ำได้หลายที่)
//    ทำอะไร: เลือก+ตรวจไฟล์สลิป แล้วอัปโหลดเข้าออเดอร์ (POST /orders/:id/upload-slip) — เรียกได้จาก
//    การ์ดแจ้งเตือน/แถบเตือน Layout/ประวัติออเดอร์ โดยไม่ต้องเปิดหน้ารายละเอียดก่อน
