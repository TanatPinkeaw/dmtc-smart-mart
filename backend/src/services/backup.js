// ═══════════════════════════════════════════════════════════════════════════════════
// 📄 services/backup.js — สำรอง/กู้คืนฐานข้อมูล (dump ทั้ง DB เป็นไฟล์ .sql.gz)
// ─────────────────────────────────────────────────────────────────────────────────────
// ทำอะไร: createBackup(pool) อ่านทุกตารางผ่าน SQL แล้วเขียนเป็นไฟล์ SQL บีบอัด gzip — เก็บลงดิสก์
//   + อัปสำเนาขึ้น Cloudinary (กันหายตอน Render redeploy); restoreBackupRow() นำไฟล์กลับมา import
// จุดสำคัญ: เขียนด้วย pure Node + zlib ไม่พึ่ง mysqldump/gzip ภายนอก → รันได้ทุก OS (รวม Windows dev)
// ═══════════════════════════════════════════════════════════════════════════════════
