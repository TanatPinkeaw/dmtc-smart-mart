// ═══════════════════════════════════════════════════════════════════════════════════
// 📄 controllers/memberController.js — สมัคร/ผูกบัญชีสมาชิกผ่าน LINE LIFF
// ─────────────────────────────────────────────────────────────────────────────────────
// ทำอะไร: 2 handler — checkLine (เช็คว่าบัญชี LINE นี้ผูกสมาชิกแล้วยัง) + registerViaLine (สมัครใหม่
//   หรือผูก line_user_id เข้ากับสมาชิกเดิมที่ student_id/เบอร์ตรงกัน) แล้ว login ให้เลย — ดู routes/memberRoutes.js
// จุดสำคัญ: ใช้ transaction + FOR UPDATE กันสมัครซ้ำพร้อมกัน; ส่ง access_token กลับเป็น bearer fallback
//   เหมือน authController (เส้น LINE)
// ═══════════════════════════════════════════════════════════════════════════════════
