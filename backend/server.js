...
// ⭐️ Phase A (refactor) — /api/reports/weekly-sales + /api/reports/hourly-sales ย้ายไปที่
// src/controllers/reportController.js + src/routes/reportRoutes.js แล้ว (mount /api/reports ด้านบน)
// พฤติกรรม/path เดิมไม่เปลี่ยน
